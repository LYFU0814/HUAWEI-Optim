...
def balanceO(phi, SINR_mtx, shape, cell, diff_expected=0.005, max_exchange=1000000):
    ...
    phi[row1][cell][row1][col1], phi[row2][cell][row2][col2] = (phi[row2][cell][row2][col2][0],phi[row1][cell][row1][col1][1]), (phi[row1][cell][row1][col1][0], phi[row2][cell][row2][col2][1])
